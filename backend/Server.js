...
app.post("/", (req, res) => {
  ...
  const sqlqry =
    "INSERT INTO fakeproductidentification (email, name, company, empid, password) VALUES (?, ?, ?, ?, ?)";
...
app.post("/login",(req, res)=>{
  ...
  const loginqry = "select * from fakeproductidentification where binary email = ? and binary password = ?";
